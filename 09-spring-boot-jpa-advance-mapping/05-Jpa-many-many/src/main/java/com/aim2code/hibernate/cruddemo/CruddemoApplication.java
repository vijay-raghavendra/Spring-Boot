...
import com.aim2code.hibernate.cruddemo.entity.*;
...
public class CruddemoApplication {
    ...
    private void CreateCourseAndStudent(AppDAO appDAO) {
        //create the couse
        Course course = new Course("New Spring Boot 6 Latest HandsOn");

        //create the student
        Student student = new Student("vijay","Raghvendra","vijay@emial.com");
        Student student1 = new Student("Naveen","Kumar","naveen@Email.com");
    ...
    private void CreateCourseAndReviews(AppDAO appDAO) {
        Course course = new Course("Latest Spring Boot for Intermediate Job seekers");

        List<Review> reviews = new ArrayList<>();

        Review review1 = new Review("Good one - 5 star");
        Review review2 = new Review("Nice one - 4 star");
        Review review3 = new Review("Bad  one - 1 star");
